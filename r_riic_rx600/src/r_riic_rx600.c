...
volatile struct st_riic0 __evenaccess * g_riic_channels[74] =
{    
...
#if(1) /* Alternative use of SDA delay feature */
    (*g_riic_channels[channel]).ICMR2.BIT.SDDL = 7;   /* Delay for 7 clocks = 166*7 = 1166nS delay. */
#endif                 
